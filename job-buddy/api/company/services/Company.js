...
module.exports = {
  ...
  fetch: params => {
    ...
    return Company.findOne(_.pick(params, _.keys(Company.schema.paths))).populate(populate)
  },
  ...
  count: params => {
    ...
    return Company.count().where(filters.where)
  },
  ...
  remove: async params => {
    ...
    const data = await Company.findOneAndRemove(params, {}).populate(populate)
